...
import { FaUserDoctor, FaVideo, FaCalendarPlus, FaTruckMedical, FaCartShopping, } from "react-icons/fa6";
  ...
  return (
    <section className="bg-white">
      <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Explore a wide range of medical services designed for patients and professionals alike.</p>
